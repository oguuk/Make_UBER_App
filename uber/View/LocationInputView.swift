...
class LocationInputView: UIView {
    ...
    var user:User? {
        didSet { titleLable.text = user?.email }
    }
    ...
    private lazy var startingLocationTextField: UITextField = {
        ...
        tf.backgroundColor = .systemGray6 //.groupTableViewBackground 13부터 안돼서
        tf.isEnabled = false
        
        let paddingView = UIView()
        paddingView.setDimensions(height: 0, width: 10)
    ...
    private lazy var destinationLocationTextField: UITextField = {
        ...
        tf.backgroundColor = .lightGray //.groupTableViewBackground 13부터 안돼서
